...
public class PlayerController2 : MonoBehaviour
{
	...
	//当たり判定
	[SerializeField,Tooltip("当たり判定")] private CapsuleCollider CC;
	...
	void Update()
	{
        ...
        //////////////////////////////////////////////
        ///
        if (L_axisV < 0.0f && R_axisV > 0.0f && T_axis < 0.0f && D_axisH > 0.0f && Input.GetKey(KeyCode.JoystickButton2) && Input.GetKey(KeyCode.JoystickButton5))
		{
			Sound_SE.Omake();
		}
        ///
		...
		else if (Input.GetKeyDown(KeyCode.H) && Input.GetKeyDown(KeyCode.L))
		{
			Time.timeScale = 1f;
		}
		///
